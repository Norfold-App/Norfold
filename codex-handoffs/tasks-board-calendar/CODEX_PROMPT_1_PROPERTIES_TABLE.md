...
> **⛓ RUN ORDER — see `../MASTER_ORDER.md` (step 2).** **Delta 2 (the create-task popup) is SUPERSEDED by `../tasks-notes-overhaul/01`, which deletes it** and routes new-task through the full board editor. If you are running the overhaul batch too, **skip delta 2**. Deltas 1, 3, 4 still stand. Satisfy the universal Definition-of-Done GATE before declaring done.
